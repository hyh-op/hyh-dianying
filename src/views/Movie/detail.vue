    ...
    <div id="detailContainer" class="slide-enter-active">
		...
		<div id="content" class="contentDetail">
			...
			<div class="detail_list">
				...
				<div class="detail_list_content">
					<div class="detail_list_img">
						 <img v-if="detailMovie.img" :src="detailMovie.img | setDetailImg(detailMovie.img)">
					</div>
					<div class="detail_list_info">
			...
			<div class="detail_player swiper-container" ref="detail_player">
				<ul class="swiper-wrapper">
					<li v-for="(data,index) in detailMovie.photos" :key="index" class="swiper-slide">
						<div>
							<img :src="data | setThisImg(data)" alt="">
						</div>
					</li>
				</ul>
			</div>
...
export default {
	filters: {
		setThisImg: function (url) {
			if (!url) return ''
			url = url.toString()
			return url.replace('w.h/','').replace('@2500w_2500h_1l_0e','@420w_279h_80q_1e_1c')
		}
		},
	data(){
		return{
